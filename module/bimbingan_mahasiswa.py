...
def replymsg(driver, data):
    ...
    topik=msg.split('topik ')[1].split(' pertemuan')[0].replace(' ', '%20')
    pertemuan=msg.split('pertemuan ')[1].split(' nilai')[0]
    nilai=msg.split('nilai ')[1]
    msgreply='https://api.whatsapp.com/send?phone={nomoriteung}&text=iteung%20input%20bimbingan%20{tipebimbingan}%20{npm}%0Atopik%20{topikbimbingan}%0Apertemuan%20{pertemuanke}%0Anilai%20{nilai}'.format(
